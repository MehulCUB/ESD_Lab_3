...
.equ	bmem, 0x0000		;where is the beginning of memory			;;;changed from 0x1000 to 0x0000 ;;;;;; ;;;change/added ESDLAB
.equ	emem, 0x7FFF		;end of the memory							;;;changed from 0xFFFF to 0x7FFF ;;;; 	;;;change/added ESDLAB
...
poweron:
	...
	orl 8EH,#0CH				;;;; SET XRAM SIZE = 1KB 	;;;change/added ESDLAB
	acall	intr_return
	acall	intr_return
	cpl	a
	mov	p0, a
